...
namespace Darkpony\WCMSPolls\Http\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Darkpony\WCMSPolls\Helpers\PollHandler;
use Darkpony\WCMSPolls\Http\Request\PollCreationRequest;
use Darkpony\WCMSPolls\Poll;
use Darkpony\WCMSPolls\Exceptions\DuplicatedOptionsException;
...
class PollManagerController extends Controller
{
    ...
    public function index()
    {
        $polls = Poll::withCount('options', 'votes')->get()->map(function ($poll){
            //if($poll->isRunning() || $poll->isComingSoon()) {
        ...
        return view('wcmspolls::dashboard.index', compact('polls'));
    }
     ...
     * @throws \Darkpony\WCMSPolls\Exceptions\CheckedOptionsException
     * @throws \Darkpony\WCMSPolls\Exceptions\OptionsInvalidNumberProvidedException
     * @throws \Darkpony\WCMSPolls\Exceptions\OptionsNotProvidedException
     */
    ...
    public function edit(Poll $poll)
    {
        ...
        return view('wcmspolls::dashboard.edit', compact('poll', 'options', 'canChangeOptions'));
    }
    ...
    {
        return view('wcmspolls::dashboard.create');
    }
