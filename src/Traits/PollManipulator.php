...
use Darkpony\WCMSPolls\Exceptions\CheckedOptionsException;
use Darkpony\WCMSPolls\Exceptions\OptionsInvalidNumberProvidedException;
use Darkpony\WCMSPolls\Exceptions\OptionsNotProvidedException;
use Darkpony\WCMSPolls\Exceptions\RemoveVotedOptionException;
...
trait PollManipulator
{
    ...
    public function detach($options)
    {
        ...
        if ($this->isRadio()) {
            ...
            return PollOption::destroy($oldOptions) == $count;
        }
